...
driver.get("https://www.ebay.com/str/newtrendauto")
...
for sku in sku_list:
    # search page link
    new_page_link = f"https://www.ebay.com/str/newtrendauto?_bkw={sku[0]}"
    ...
    for i in range(1, 6):
        try:
            if i == 2:
                new_page_link = f"https://www.ebay.com/str/newtrendauto?_bkw={sku[0]}&_pgn=2"
                driver.get(new_page_link)
            elif i ==3:
                new_page_link = f"https://www.ebay.com/str/newtrendauto?_bkw={sku[0]}&_pgn=3"
                driver.get(new_page_link)
            elif i ==4:
                new_page_link = f"https://www.ebay.com/str/newtrendauto?_bkw={sku[0]}&_pgn=4"
                driver.get(new_page_link)
            elif i ==5:
                new_page_link = f"https://www.ebay.com/str/newtrendauto?_bkw={sku[0]}&_pgn=5&rt=nc"
                driver.get(new_page_link)
        except:
            pass
        # search result page
        ...
        for product_table in product_tables:
            ...
            if first_product is True:
                ...
                wb.save("newtrendauto.xlsx")
                first_product = False

            workbook = load_workbook("newtrendauto.xlsx")
            ...
            workbook.save("newtrendauto.xlsx")
            driver.back()
            time.sleep(2)
